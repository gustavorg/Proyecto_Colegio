...
public class AdapterMiercoles extends ArrayAdapter<Alumno_SeccionBean> {

    ArrayList<Alumno_SeccionBean> lista_notas = new ArrayList<>();
    public AdapterMiercoles(Context context, int textViewResourceId, ArrayList<Alumno_SeccionBean> objects) {
