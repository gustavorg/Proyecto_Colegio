...
public class AdapterMartes extends ArrayAdapter<Alumno_SeccionBean> {

    ArrayList<Alumno_SeccionBean> lista_notas = new ArrayList<>();
    public AdapterMartes(Context context, int textViewResourceId, ArrayList<Alumno_SeccionBean> objects) {
