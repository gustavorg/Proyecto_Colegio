...
public class AdapterJueves extends ArrayAdapter<Alumno_SeccionBean> {

    ArrayList<Alumno_SeccionBean> lista_notas = new ArrayList<>();
    public AdapterJueves(Context context, int textViewResourceId, ArrayList<Alumno_SeccionBean> objects) {
