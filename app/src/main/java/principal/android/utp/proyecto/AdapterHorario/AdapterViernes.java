...
public class AdapterViernes extends ArrayAdapter<Alumno_SeccionBean> {

    ArrayList<Alumno_SeccionBean> lista_notas = new ArrayList<>();
    public AdapterViernes(Context context, int textViewResourceId, ArrayList<Alumno_SeccionBean> objects) {
